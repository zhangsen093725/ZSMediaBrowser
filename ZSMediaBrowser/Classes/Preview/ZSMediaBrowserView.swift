...
@objcMembers open class ZSMediaBrowserView: UIView {
    ...
    var minimumSpacing: CGFloat = 0 {
        didSet {
            collectionView.frame.size.width = contentView.bounds.width + minimumSpacing
    ...
    open override func layoutSubviews() {
        ...
        collectionView.frame = CGRect(x: 0, y: 0, width: bounds.width + minimumSpacing, height: frame.height)
    }
...
/**
 * ZSMediaBrowserView 动画
 */
@objc extension ZSMediaBrowserView {
